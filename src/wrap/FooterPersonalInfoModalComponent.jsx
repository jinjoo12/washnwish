...
export default function FooterPersonalInfoModalComponent(){
    ...
    const onClickCloseBtn=(e)=>{
        ...
        dispatch(footerPersonalInfoModal(false));          
        const htmlEl = document.getElementsByTagName('html')[0];
        htmlEl.classList.remove('on');
    }

    return(
        <div id="footer-personalInfo-modal" className="footer-modal" >
                ...
                <div className="content">
                    <div className="modal-box">
                        ...
                        <div className="txt-box">
                            <p>
                                    워시앤위시 (이하 '사이트’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.<br />
                                <br />
                                ...
                                성명 : OOO<br />
                                직책 : OOO<br />
                                연락처 : &lt;02-6219-6219&gt;,&lt;팩스번호&gt;<br />
                                ※ 개인정보 보호 담당부서로 연결됩니다.<br />
                                <br />
                                ▶ 개인정보 보호 담당부서<br />
                                부서명 : 워시앤위시 cs센터<br />
                                담당자 : cs팀<br />
                                연락처 : &lt;02-6219-6219&gt,&lt;팩스번호&gt;<br />
                                <br />
                                ...
                                <br />
                                “전진바이오팜(주)”은 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다. “전진바이오팜(주)”의 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다.<br />
                                - 수탁자 : (주)루나소프트<br />
                                - 개인정보제공처 : 주식회사 카카오<br />
