    ...
    return (
        <div id='signUp'>
            <div className="container">
                ...
                <div className="chk chk1">
                    ...
                    <div className="content">
                        <p>
						    제1조 목적<br/>
                            <br/>
                            본 이용약관은 “워시앤위시”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반사항 규정을 목적으로 합니다.<br/>
                            <br/>
                            제2조 용어의 정의<br/>
                            <br/>
                            ...
                            <br/>
                            제17조 할인쿠폰<br/>
                            1. 회사는 회원에게 일정 금액 또는 일정비율을 할인 받을 수 있는 쿠폰을 발급할 수 있습니다. 쿠폰의 종류 및 내용과 발급여부 및 사용방법은 회사의 정책에 따라 변경될 수 있습니다.<br/>
                            2. 할인쿠폰은 사전에 명시된 유효기간 내에 사용될 수 있으며, 유효기간이 경과하거나 회원 자격이 상실되면 소멸합니다. 회사는 쿠폰의 발급시 및 쿠폰의 유효기간 만료 전 회원에게 통지합니다.<br/>
                            3. 회원이 할인쿠폰을 사용하여 구매한 제품을 취소나 반품하는 경우, 환불금액은 할인쿠폰을 통해 할인된 금액 등을 제외하고 회원이 실제 지급한 금액으로 합니다. 환불이 이루어졌을 때에는 할인쿠폰의 재사용이 불가능할 수 있습니다.<br/>
                            4. 회사는 포인트 또는 쿠폰의 유효기간 만료 및 소멸 관련하여 회원에게 통지합니다.<br/>
                            <br/>
                            부칙<br/>
                            #카카오톡 알림톡 시행에 관한 내용<br/>
                            <br/>
                            “전진바이오팜(주)”은 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내 드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.<br/>
                            <br/>
                ...
                <div className="chk chk3">
                    <span>마케팅 활용 동의 및 광고 수신 동의</span>
                    <div className="content">
                        <p>
                            귀사의 로그인 서비스와 관련하여 본인은 귀사가 제공하는 공지사항, 서비스 관련 정보, 쿠폰, 이벤트, 상품소개, 맞춤형 광고를 위한 개인정보 수집 이용에 동의 합니다.<br/>
                            <br/>
                            <br/>
                            1. 개인정보 수집·이용 동의에 관한 사항<br/>
                            1) 개인정보 수집·이용의 목적 - 공지사항, 이벤트, 쿠폰, 맞춤형 광고 관련 정보 제공<br/>
                            - 사은/판촉 행사 등의 마케팅 활동, 멤버쉽등 서비스에서 제공되는 혜택소개 및 안내<br/>
                            - 회사 및 제휴사의 상품/서비스안내, 홍보, 가입권유 활동과 서비스 품질 향상을 위한 설문조사 등 서비스 제반 프로모션 이벤트 활동<br/>
                            2) 수집 이용할 개인(신용)정보의 내용<br/>
                            - 성명, 휴대폰번호, 성별, 생년월일<br/>
                            <br/>
                            3) 개인(신용)정보의 보유 및 이용기간<br/>
                            - 수집/이용 동의일로부터 개인(신용)정보의 수집이용 마케팅 이용동의를 해지하기 전까지 보유하는 것을 원칙으로 합니다.<br/>
                            (단, 서비스 분쟁해결 민원처리, 법령상 의무이행 등 관계법령과 내규에 의해 개인정보를 보존할 필요가 있는 경우 관계법령에서 정한 기간 동안 보유/이용 합니다.)<br/>
                            2. 마케팅 이용동의 해지 및 방법<br/>
                            - 회사는 원칙적으로 사용자가 마케팅이용을 원하지 않을 때 다음과 같은 방법으로 마케팅 수신을 거부할 수 있습니다.<br/>
                            - 고객센터 02-6219-6219 로 안내 받을 수 있습니다.<br/>
                            3. 동의를 거부할 권리 및 동의를 거부할 경우의 불이익<br/>
                            - 마케팅 서비스 이용을 위하여 본 내용에 동의하셔야만 서비스의 이용이 가능하며, 동의하지 않으셔도 회원가입 및 이용이 가능하나, 관련 편의 제공(이벤트, 프로모션, 맞춤형 광고 제공 등)에 일부 제한이 있을 수 있습니다.<br/>
                            <br/>
                        </p>
                    </div>
                    <label>
                ...
                <div className="button-box">
                    <Link to='/signIn' className='cancel'>취소</Link>
                    <Link to='/signUp2' className='join'>가입하기</Link>
                </div>
            </div>
        </div>
    );
